            ...
            public void onClick(View v) {
                ...
                if(boxExternal.isChecked()){
                    try(FileReader fromSource = new FileReader(source)) {
                        ...
                        Toast.makeText(getApplicationContext(), getString(R.string.fileExeption),
                ...
                if (!loginSuccess) {
                    Toast.makeText(getApplicationContext(), getString(R.string.loginPasswordNotFound),
                            Toast.LENGTH_LONG).show();
                }
            }
        });
            ...
            public void onClick(View v) {
                ...
                if (boxExternal.isChecked()) {
                    try (FileWriter toSource = new FileWriter(source, true)) {
                        ...
                        toSource.close();
                        Toast.makeText(getApplicationContext(), getString(R.string.successFileWrite),
                                Toast.LENGTH_LONG).show();
                    } catch (IOException e) {
                        Toast.makeText(getApplicationContext(),getString(R.string.fileExeption),
                                Toast.LENGTH_LONG).show();
        ...
        try {
            while ((log = brUsers.readLine()) != null && (pas = brUsers.readLine()) != null) {
                if (log.equals(inName) && pas.equals(inPassword)) {
                    Toast.makeText(getApplicationContext(), getString(R.string.successLogin),
                            Toast.LENGTH_LONG).show();
                    return true;
                }
            }
